		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="${pageContext.request.contextPath}/"
						class="nav-link">Home</a></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="" id="dropdown04"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" href="<c:url value="/shop" />">Shop</a> <a
			...
			<div class="row">
				<c:forEach var="product" items="${product}">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="product">
							<a href="<c:url value="/${product.id}" />" class="img-prod"><img class="img-fluid"
								src="${product.imageProduct}" alt="Colorlib Template"> <span
								class="status">${product.salePercent}</span>
							...
							<div class="text py-3 pb-4 px-3 text-center">
								...
								<div class="d-flex">
									<div class="pricing">
										<p class="price">
											<span class="mr-2 price-dc">${product.priceSaled }</span><span
												class="price-sale">${product.price }</span>
										</p>
									</div>
								</div>
				...
				<div class="col-md-12">
					<div class="carousel-testimony owl-carousel">
						...
						<div class="item">
							<div class="testimony-wrap p-4 pb-5">
								<div class="user-img mb-5"
									style="background-image: url(resources/images/person_5.jpg)">
									<span
										class="quote d-flex align-items-center justify-content-center">
										<i class="icon-quote-left"></i>
									</span>
