					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="product">
							<a href="<c:url value="/${product.id}" />" class="img-prod"><img class="img-fluid"
								src="${product.imageProduct}" alt="Colorlib Template">
								<span class="status">${product.salePercent}%</span>
								<div class="overlay"></div> </a>
							<div class="text py-3 pb-4 px-3 text-center">
								<h3>
									<a href="<c:url value="/${product.id}" />">${product.name}</a>
								</h3>
								<div class="d-flex">
									<div class="pricing">
										<p class="price">
											<span class="mr-2 price-dc">${product.price}</span><span
												class="price-sale">${product.priceSaled}</span>
										</p>
									</div>
								</div>
