		...
		<div class="container">
								...
								<tbody>
									...
									<tr class="text-center">
										...
										<td class="image-prod"><div class="img"
												style="background-image: url(${product.imageProduct});"></div></td>
										...
										<td class="quantity">
											<div class="input-group mb-3">
												<input  type="text" name="quantity"
													...
													min="1" max="100" oninput="caculatePrice()">
											</div>
										</td>
			...
			for(let i = 0;i< inputs.length;i++){
				inputs[i].addEventListener("change",function(){
					let data = document.getElementsByClassName("input-number")[i].value;
					let price = prices[i].innerHTML.split("$")[1]
					let total = price * data;
					document.getElementsByClassName("total")[i].innerHTML = "$" + Math.round(total * 100)/100;
					var listTotal = document.getElementsByClassName("total");
					var subTotal = 0;
					for(let i = 0;i< listTotal.length;i++){
						subTotal += +listTotal[i].innerHTML.split("$")[1];
					}
					document.querySelectorAll("body > section.ftco-section.ftco-cart > div > div.row.justify-content-end > div:nth-child(3) > div > p:nth-child(2) > span:nth-child(2)")[0].innerHTML = "$" + subTotal
					let discount = document.querySelector("body > section.ftco-section.ftco-cart > div > div.row.justify-content-end > div:nth-child(3) > div > p:nth-child(4) > span:nth-child(2)").innerHTML;
					discount = +discount.split("$")[1];
					document.querySelector("body > section.ftco-section.ftco-cart > div > div.row.justify-content-end > div:nth-child(3) > div > p.d-flex.total-price > span:nth-child(2)").innerHTML = "$" + (subTotal - discount)
				})
			}
		},false);
				...
				function xuLi(){
					...
					var url = "saleCode?saleCode=" +saleCode;
					
					console.log("ho ten la: " + saleCode);
			...
			<div class="row justify-content-end">
				<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
					<div class="cart-total mb-3">
						...
						<form action="saleCode" class="info" method="post">
							<div class="form-group">
								<label for="">Sale code</label> <input id="saleCode" type="text"
									class="form-control text-left px-3" name="saleCode">
							</div>
						</form>
					</div>
					
						
						<button class="btn btn-primary py-3 px-4" onclick="xuLi()" >Sale Code</button>
