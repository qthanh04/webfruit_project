			...
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-1.jpg" class="image-popup"><img
						src="${product.imageProduct }" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div class="row mt-4">
						...
						<div class="w-100"></div>
						<div class="col-md-12">
							<p style="color: #000;">avaiable ${product.avaiable }</p>
						</div>
					</div>
					<p>
						<a href="cart/${product.id }" class="btn btn-black py-3 px-5">Add
							to Cart</a>
					</p>
			...
			<div class="row">
				<c:forEach var="product" items="${product1}">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="product">
							<a href="<c:url value="/${product.id}" />" class="img-prod"><img
								class="img-fluid" src="${product.imageProduct}"
								alt="Colorlib Template"> <span class="status">${product.salePercent}</span>
